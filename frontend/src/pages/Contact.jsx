      ...
      <section className="relative bg-gradient-to-b from-sara-cream to-[#FDFBF7]">
        ...
        >
          ...
          <div className="flex-1 w-full lg:min-w-[500px] lg:max-w-[600px] z-10">
            ...
            <p data-aos="fade-up" className="m-0 mb-4 font-serif italic text-[18px] text-sara-gold">
              {t('contactPage.sectionTitle')}
            </p>

            <h2 data-aos="fade-up" data-aos-delay="100" className="m-0 mb-10 font-serif text-[clamp(36px,4.5vw,48px)] font-normal leading-[1.2] text-[#2A1635]">
            ...
            <div data-aos="fade-up" data-aos-delay="300" className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-10 font-sans">
              <div>
            ...
            <button data-aos="fade-up" data-aos-delay="400" className="bg-transparent text-sara-gold border border-sara-gold px-8 py-3 font-sans text-[12px] font-medium uppercase tracking-[1.5px] cursor-pointer transition-all duration-300 inline-block hover:bg-sara-gold hover:text-[#2A1635]">
